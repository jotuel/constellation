...
pub struct Constellation {
    ...
    /// `selected_space` (`None` = "All rooms" entry at position 0).
    pub(crate) space_nav_model: cosmic::widget::nav_bar::Model,
    /// Hash of (id, name, avatar_url) over the current joined spaces; gates
...
pub enum Message {
    ...
    DndFileTransfer(String),
    DndFileTransferFinished(Result<Vec<String>, String>),
...
impl MenuAction for MenuAct {
    ...
    fn message(&self) -> Self::Message {
        match self {
            ...
            MenuAct::ToggleActiveThreadsPanel => Message::ToggleActiveThreadsPanel,
