...
close-active-threads = Close Active Threads
...
no-session-errors = No errors recorded in this session.
clear-all = Clear All
...
decline = Decline
verification-request-received = Verification Request Received
verification-request-from = Verification requested by { $sender } (Device { $device })
verification-request-from-device = Verification requested by device { $device }
...
login-qr-check-code-prompt = Enter the two-digit code shown on your other device to confirm the secure connection.
login-qr-check-code-placeholder = Check code
login-qr-check-code-invalid = Invalid check code. Please try again.
login-qr-authenticating = Device authorized! Authenticating and signing in...
login-qr-syncing = Transferring encryption keys and verifying device...
...
error-failed-save-media = Failed to save media: { $error }
media-saved = Saved to { $path }
error-failed-play-video = Failed to play video: { $error }
error-video-playback = Video playback error: { $error }
...
error-failed-open-browser = Failed to open browser: { $error }. Please visit: { $url }
...
error-failed-fetch-active-threads = Failed to fetch active threads: { $error }
...
shortcut-close-space-switcher = Close Space Switcher
